...
<div class="siderbar-menu tab-content">
            <?php foreach ($menuGroups as $key => $menuGroup): ?>
                 <ul id="menu-group-<?= $menuGroup['id'] ?>" class="nav tab-pane <?php if ($key == 0) {echo 'active';} ?>" >
                        <?php if(!empty($newAllMenu[$menuGroup['id']])):?>
                        <?php $v1=$newAllMenu[$menuGroup['id']];?>
                            <?php
                            $data = json_decode($v1['data'], true);?>
                                ...
                                <?php if(array_key_exists('_child',$v1)):?>
                                    <ul class="nav nav-second-level">
                                        <?php  foreach($v1['_child'] as $v2):?>
                                                    ...
                                                    <?php if(!empty($v2['_child'])):?>
                                                        <ul class="nav nav-third-level ">
                                                            <?php  foreach($v2['_child'] as $v3):?>
                                                                <li ><!--三级菜单-->
                                                                    <a class="J_menuItem" href="<?= Url::toRoute($v3['route']);?>" data-index="0">
                                                                        <?php if($v3['icon']):?>
                                                                            <?= Html::icon($v3['icon']) ?>
                                                                        <?php endif;?>
                                            ...
                                            <?php else:?>
                                                <li ><!--二级菜单-->
                                                    <a class="J_menuItem" href="<?= Url::toRoute($v2['route']);?>" data-index="0">
                                                        <?php if($v2['icon']):?>
                                                            <?= Html::icon($v2['icon']) ?>
                                                        <?php endif;?>
                                                        <span class="nav-label"><?= $v2['name']?></span>
