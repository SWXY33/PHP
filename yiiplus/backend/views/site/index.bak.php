            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        ...
                        <nav class="navbar navbar-static-top clear" role="navigation" style="margin-bottom: 0">
                            ...
                            <ul class="nav navbar-top-links navbar-right">
                                <li>
                                    <div class="dropdown profile-element" style="padding:10px 10px;min-height: 50px;">
                                <span class="m-t-xs" style="padding:10px;">
                                    <img alt="image" style="width:35px;" class="img-circle" src="<?php echo Url::to('@web/img/profile_small.jpg');?>" />
                                </span>
                                        <span  data-toggle="dropdown" class="dropdown-toggle" href="#" style="float:right;padding-top:0px;">
                                    <span class="clear">
                                        <span class="block m-t-xs"><strong class="font-bold"><?= Yii::$app->user->identity->username ?></strong></span>
                                        <span class="text-muted text-xs block"><?= $user_info?><b class="caret"></b></span>
                                    </span>
