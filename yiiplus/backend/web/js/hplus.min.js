...
//因为之前使用id进行选择#side-menu,不方便,改成了使用类.side-menu
function SmoothlyMenu() {
    $("body").hasClass("mini-navbar") ? $("body").hasClass("fixed-sidebar") ? ($(".side-menu").hide(), setTimeout(function() {
			$(".side-menu").removeAttr("style");
            $(".side-menu.active").fadeIn(100);
        },
        300)) : $(".side-menu").not('.active').removeAttr("style") : ($(".side-menu").hide(), setTimeout(function() {
			$(".side-menu").removeAttr("style");
            $(".side-menu.active").fadeIn(100);
        ...
        100))
    ;
    $("body").hasClass("mini-navbar")?$(".mini-navbar").find('li').tooltip({selector:"[data-toggle=tooltip]",container:"body"}):$("ul").find('li').tooltip('destroy');
}
//因为之前使用id进行选择#side-menu,不方便,改成了使用类.side-menu
